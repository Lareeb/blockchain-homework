...
# YOUR CODE HERE
numbr_from_sender = st.text_input("Sender, send me your number")
# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
# YOUR CODE HERE
numbr_from_receiver = st.text_input("Receiver, send me your number")
# @TODO:
# Add an input area where you can get a value for `amount` from the user.
# YOUR CODE HERE
all_the_numbr = st.text_input("How many phone numbers do you have")
